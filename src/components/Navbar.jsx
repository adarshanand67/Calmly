...
const Navbar = () => {
  const headersData = ["Home", "About", "Contact", "Services","Meditation"];
  ...
  return (
    <nav className="rounded border-gray-200 bg-white px-2 py-2.5 dark:bg-gray-900 sm:px-4">
      <div className="container mx-auto flex flex-wrap items-center justify-between">
        <a href="https://calmly.com/" className="flex items-center">
        ...
        <div className="flex items-center md:order-2">
          <button
            ...
            className="inline-flex cursor-pointer items-center justify-center rounded-lg px-4 py-2 text-sm text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 dark:hover:text-white"
          >
            <svg
